...
You've been approved as a Isaac Kiptanui Maiywa for MP Turbo 2027 volunteer! 🎉
...
— Isaac Kiptanui Maiywa for MP Turbo 2027`;
...
`<div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;color:#0D0D0D">
  <div style="background:#0D0D0D;padding:20px;border-radius:12px 12px 0 0">
    <h2 style="color:#F5C100;margin:0">Isaac Kiptanui Maiywa for MP Turbo 2027</h2>
  </div>
  <div style="border:1px solid #eee;border-top:none;padding:24px;border-radius:0 0 12px 12px">
    <p>Hi ${first},</p>
    <p>You've been <strong>approved</strong> as a Isaac Kiptanui Maiywa for MP Turbo 2027 volunteer! 🎉</p>
    ...
    <p style="margin-top:24px">Kirgit Kipkeleny Tulwo! 🇰🇪<br>— Isaac Kiptanui Maiywa for MP Turbo 2027</p>
  </div>
</div>`;

  return sendEmail({ to, subject: "You're approved — activate your Isaac Kiptanui Maiywa for MP Turbo 2027 volunteer account", text, html });
}
...
export function pledgeEmailSubject(kind: PledgeEmailKind): string {
  return kind === 'thank_you'
    ? 'Thank you for your pledge to Isaac Kiptanui Maiywa for MP Turbo 2027'
    : 'Donations are now ready — support Isaac Kiptanui Maiywa for MP Turbo 2027';
}
...
Thank you for pledging your support to Isaac Kiptanui Maiywa for MP Turbo 2027. Your commitment means a great deal to our campaign and the communities we serve.

No payment has been taken. We will email you when donations are ready.

Kirgit, Kipkeleny Tulwo! 🇰🇪
— Isaac Kiptanui Maiywa for Turbo 2027`;
    const html = `<div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;color:#0D0D0D"><div style="background:#0D0D0D;padding:20px;border-radius:12px 12px 0 0"><h2 style="color:#F5C100;margin:0">Isaac Kiptanui Maiywa for MP Turbo 2027</h2></div><div style="border:1px solid #eee;border-top:none;padding:24px;border-radius:0 0 12px 12px"><p>Hi ${safeName},</p><p>Thank you for pledging your support to <strong>Isaac Kiptanui Maiywa for MP Turbo 2027</strong>. Your commitment means a great deal to our campaign and the communities we serve.</p><p>No payment has been taken. We will email you when donations are ready.</p><p style="margin-top:24px">Kirgit, Kipkeleny Tulwo! 🇰🇪<br>— Isaac Kiptanui Maiywa for MP Turbo 2027</p></div></div>`;
